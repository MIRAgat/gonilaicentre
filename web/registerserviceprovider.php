              ...
              <option value = "bookdoc">Health Services Booking</option>
			   <option value = "homeservice">Home Services</option>
											...
											<hr>
												...
												<div class="form-sub-w3ls">
													<input placeholder="Password" name="password" id="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Your password must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters. Please fill it now to proceed with your registration."type="password" required="">
													<div class="icon-agile">
