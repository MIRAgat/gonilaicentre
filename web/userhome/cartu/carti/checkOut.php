    ...
    <h2>My Shopping Cart</h2>
        <table class='table'> <!--Start table that will holds all data in the shopping cart --> 
            ...
            <tr class='itemInCardRow'>            
                ...
                <td class='itemInCartDisplay'>
                    <?php echo "RM".sprintf("%.2f", ($item["item_price"] * $item["item_qty"])); ?>
                </td>
            </tr>
            <?php
                /* Calculate Total */
            ...
            <tr>                 
                <td class='itemInCartDisplay' colspan='4'>
                    <div>
                        <a href='payment/HTML/payment.php' title="Go To Payment"><button type="button" class="btn checkout_btn">Go To Payment</button></a>
