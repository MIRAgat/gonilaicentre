    ...
    <?php    
        ...
        if(isset($_GET['menu'])){
            ...
            if($menuCategory =="main"){
                $items = $database->find_by_query("SELECT * FROM shopping_items WHERE vendorid='$_GET[id]'");    
            /* Categories accordingly */
            }else{            
                $items = $database->find_by_query("SELECT * FROM shopping_items WHERE category='{$menuCategory}' AND vendorid='$_GET[id]'");    
            }
        }else{
            $items = $database->find_by_query("SELECT * FROM shopping_items WHERE vendorid='$_GET[id]'");    
        }
