...
<div class="why-choose-agile" id="about">
		<div class="container">
			<h3 class="w3l_head">Home Services</h3>
			          <p class="w3ls_head_para">Home :Where the Heart is.</p>
					  <style>
...
$rows=$db->query("SELECT `id`, `typeserv`, `bussname`, `profile_image` FROM `serviceproviderlogin` WHERE typeserv = 'homeservice' ");
                              
									
while(list($id, $typeserv, $bussname, $profile_image )=$rows->fetch_row())
{									
                                 
 			 					
					echo	"<div class='col-md-4'>";
					echo	"<div class='col-xs-12 agile-why-text two'>";
	
						echo"	<h4>$bussname</h4> ";
						
						echo"	<div class='cont-img-logo'> ";
			             echo"   <a href= cartu2/carti2/index.php?id=$id><img src='../vendorhome/homeservice/uploads/$profile_image' id='size' ></a>";
						echo "	</div>"	;
						echo"<br>";
