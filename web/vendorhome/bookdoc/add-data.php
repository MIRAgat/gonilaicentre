...
move_uploaded_file($_FILES['img']['tmp_name'],"images/".$_FILES['img']['name']);
	...
	for($i=1; $i<=$total; $i++)
	{
		...
		$sql="INSERT INTO shopping_items(vendorid,item_name,item_desc,item_id,item_image,item_price,category) VALUES('".$fn6."','".$fn."','".$fn1."','".$fn2."','".$n_img."','".$fn4."','".$fn5."')";
		$sql = $db->query($sql);		
	}
...
if(isset($_POST['btn-gen-form']))
{
	...
	for($i=1; $i<=$_POST["no_of_rec"]; $i++) 
	{
		...
		<td><input type="text" name="item_id<?php echo $i; ?>" placeholder="item id" class='form-control' required/></td>
		<td><input type='file' name="item_image<?php echo $i; ?>" id="item_image" ></td>
		<td><input type="text" name="item_price<?php echo $i; ?>" placeholder="Price" class='form-control' required/></td>
		<td><input type="text" name="category<?php echo $i; ?>" placeholder="Category" class='form-control' required/></td>
