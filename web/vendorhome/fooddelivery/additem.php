...
<div class="content">
<a href="generate.php" class="btn btn-large btn-info"><i class="glyphicon glyphicon-plus"></i> &nbsp; Add Menu</a>
<br/>
...
<?php
	$res = $db->query("SELECT * FROM shopping_items WHERE vendorid=$loggedin_id");
	$count = $res->num_rows;
	...
	if($count > 0)
	{
		while($row=$res->fetch_array())
		{
			...
			<td><?php	echo "<img src='../../userhome/cartu/carti/images/$n_img' class=\"avatar border-gray\" alt=\"...\">" ?></td>
