...
$state = $_POST['state']; 
  ...
  $result = ("UPDATE users SET nickname='$nickname', pob='$pob', address='$address', postcode='$postcode', town='$town', state= '$state',  status='$status' WHERE id=$loggedin_id");
                                ...
                                <form role="form" action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Company" value="<?php  echo  $dob;  ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Plac of birthday</label>
									...
									<div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Gender</label>
                                                <input type="text" class="form-control" placeholder="City" value="<?php  echo  $gender;  ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Religion</label>
                                                <input type="text" class="form-control" placeholder="Country" value="<?php  echo  $religion;  ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Race</label>
                                                <input type="text" class="form-control" placeholder="ZIP Code" value="<?php  echo  $race;?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
