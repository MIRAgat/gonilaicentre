            ...
            <div class="container">
                ...
                <!-- Brand and toggle get grouped for better mobile display -->
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">Planet Tomyam</a>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div id="w">
                            ...
                            <ul id="portfolio">
                                <li class="item breakfast"><img src="images/kkpt.jpg" alt="Food" >
                                    <h2 class="white">RM 7</h2>
                                </li>

                                <li class="item dinner special"><img src="images/spagettipt.jpg" alt="Food" >
                                    <h2 class="white">RM 12</h2>
                                </li>
                                <li class="item dinner breakfast"><img src="images/kueypt.jpg" alt="Food" >
                                    <h2 class="white">RM 8</h2>
                                </li>
                                <li class="item special"><img src="images/pulmanpt.jpg" alt="Food" >
                                    <h2 class="white">RM 11</h2>
                                </li>
