...
<div class="why-choose-agile" id="about">
		<div class="container">
			<h3 class="w3l_head">Doctor booking</h3>
			          <p class="w3ls_head_para">Heal yourself with professional doctors</p>
			<div class="why-choose-agile-grids-top">
					<style>
						...
						<div class="col-xs-12 about-grid2-right">
						
						
							<h4>Klinik Salak</h4>
							<div class="cont-img-logo" href="vendlistfo.php"> </a>
			                <a href="http://localhost/web/userhome/didi.php?#Servicess"><img src="salak.JPG" id="size" onclick= "href= 'Restaurant-master/indexfood.php'"></a>
							</div>	
						...
						<div class="col-xs-12 about-grid2-right">
							...
							<h4>Tiew Dental Nilai</h4>
							<div class="cont-img-logo" href="vendlistfo.php"> </a>
			                <a href="http://localhost/web/userhome/didi.php?#Servicess"><img src="Tiew.JPG" id="size" onclick= "href= 'Restaurant-master/indexfood.php'"></a>
							</div>	
					...
					<div class="col-md-4">
						...
						<div class="col-xs-12 about-grid2-right">
							...
							<h4>Klinik Medivon</h4>
							<div class="cont-img-logo" href="vendlistfo.php"> </a>
			                <a href="http://localhost/web/userhome/didi.php?#Servicess"><img src="medivon.JPG" id="size" onclick= "href= 'Restaurant-master/indexfood.php'"></a>
							</div>	
