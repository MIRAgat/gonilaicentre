...
<div class="why-choose-agile" id="about">
		<div class="container">
			<h3 class="w3l_head">Food Ordering</h3>
			          <p class="w3ls_head_para">Food never cheat!</p>
					  <style>
...
$rows=$db->query("SELECT `id`, `typeserv`, `bussname`, `profile_image` FROM `serviceproviderlogin` WHERE typeserv = 'fooddelivery' ");
...
{									
					...
					echo	"<div class='col-xs-12 agile-why-text two'>";
						...
						echo"	<div class='cont-img-logo'> ";
			             echo"   <a href= cartu/carti/index.php?id=$id><img src='../vendorhome/fooddelivery/uploads/$profile_image' id='size' ></a>";
						echo "	</div>"	;
						echo"<br>";
