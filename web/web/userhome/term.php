...
<div class="why-choose-agile" id="about">
		<div class="container">
			<h3 class="w3l_head">Term & Condition</h3>
			...
			<div class="why-choose-agile-grids-top">
					<style>
						...
						<div class="col-xs-9 agile-why-text two">
							...
							<p>
							Welcome to the GoNilaiCentre.com.my website. These terms and conditions apply to the Site.
							
						</p>
	<li>Trademark and Copyright.
	All intellectual property rights, whether registered or unregistered, in the GoNilai Centre, information content on the Site and all the website design, including, but not limited to, text, graphics, software, photos, video, music, sound, and their selection and arrangement, and all software compilations, underlying source code and software shall remain our property. The entire contents of the Site also are protected by copyright as a collective work under Malaysia copyright laws and international conventions. All rights are reserved.
	</li>
	<li>Disclaimer of liability will specify the damages that one party e.g. ecommerce store owner, will be obligated to provide to the other e.g. customer, in the event of product failure and should reflect the level of risk involved. It will also specify what the ecommerce store owner will not be responsible for in the event of any loss, liability, damage (whether direct, indirect or consequential), personal injury or expense of any nature whatsoever which may be suffered by the customer.</li>
	<li>Data Protection of customer’s and service provider's personal information will be used, stored and protected.</li>
