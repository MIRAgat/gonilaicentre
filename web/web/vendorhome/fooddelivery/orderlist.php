...
$rows=$db->query("SELECT `name`,`email`,`phonenum`,`deliverytime`,`deliveryaddress`, `status` FROM `payment`" );
...
while(list($name, $email, $phonenum, $deliverytime, $deliveryaddress, $status )=$rows->fetch_row())
{									
